...
[Wed May 20 13:50:59 2015]
-------------------------

The generator produced the following files:

The Box class:
- ovpCBoxAlgorithmGenelateStimulation.h
- ovpCBoxAlgorithmGenelateStimulation.cpp
...
You may have to change the file ovpCBoxAlgorithmGenelateStimulation.h to make it find the included file ovp_defines.h, whose path is related to the project used.
...
#include "[my-box-folder]/ovpCBoxAlgorithmGenelateStimulation.h"
...
OVP_Declare_New(OpenViBEPlugins::Tools::CBoxAlgorithmGenelateStimulationDesc);
...
